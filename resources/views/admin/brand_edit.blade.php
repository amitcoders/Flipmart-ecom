            ...
            <div class="card-body">
               ...
               @endif
                <form class="form-horizontal" method="POST" action="{{ route('update-brand')}}">
                    @csrf
                    <a class="btn btn-primary" style="margin-left: 550px;" href="">Update&nbsp;Brand</a>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-12">
                          ...
                          <input type="text" class="form-control" name="brand_name" id="brand_name" value="{{ $row['brand_name'] }}" placeholder="Brand Name" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <div class="col-lg-12">
