    ...
    <li class="nav-item">
      ...
      <div id="collapseForm" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="{{ route('add-brand')}}">Add Brands</a>
          <a class="collapse-item" href="{{ route('manage-brand')}}">Manage Brand</a>
          <a class="collapse-item" href="">Edit Brand</a>
          <a class="collapse-item" href="{{ route('add-brand')}}">All Brand</a>
        </div>

      </div>
    </li>
    <li class="nav-item">
      <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseFormcategory" aria-expanded="true"
        aria-controls="collapseForm">
        <i class="fab fa-fw fa-wpforms"></i>
        <span>Category</span>
      </a>
      <div id="collapseFormcategory" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
